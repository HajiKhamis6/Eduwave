...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* NEW BUTTON STYLE – open O.C. link */
        .oc-header-btn {
            background: #9b6d3c;        /* warm brown */
            color: white;
            border: none;
            border-radius: 40px;
            padding: 8px 16px;
        ...
        .btn-primary {
            ...
            font-size: 1.1rem; 
            color: white; 
            box-shadow: 0 10px 18px -8px #8b4e2e;
            cursor: pointer; 
            transition: 0.2s; 
            width: 100%; 
            max-width: 280px;
        ...
        .demo-panel {
            ...
            padding: 32px 20px; 
            margin: 40px 0;
            box-shadow: 0 18px 40px -12px #bb9f80; 
        ...
        .wa-contact-btn, .call-contact-btn, .oc-contact-btn {
            border: none;
            padding: 16px 20px;
            border-radius: 60px;
            font-weight: 600;
        ...
        .oc-contact-btn i { color: #fadfad; }
        .oc-contact-btn:hover { background: #865a30; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="demo-panel" id="registerDemo">
            ...
            <p style="font-size:0.8rem; margin-top:14px; color:#7b6e5a;"><i class="fas fa-mobile-alt"></i> Tap WhatsApp to join group, call directly, or try O.C. app.</p>
        </div>
    </div>
